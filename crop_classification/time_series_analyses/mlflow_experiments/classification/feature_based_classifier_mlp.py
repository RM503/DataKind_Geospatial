...
def objective(
    ...
    with mlflow.start_run(nested=True):
        ...
        mlflow.log_params(mlp_clf_params)
...
if __name__ == "__main__":
    ...
    with mlflow.start_run():
        ...
        model = MLPClassifier(**study.best_params)
        ...
        mlflow.sklearn.log_model(
            sk_model=model,
            artifact_path="timeseries_classification_MLP",
            registered_model_name="timeseries_classification_MLP",
            #signature=signature
        )